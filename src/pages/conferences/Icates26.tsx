...
const conferenceData = {
  ...
  delegates: [],
  timeline: [
    { date: "17 July 2026", label: "Paper Submission", desc: "Deadline for paper submission" },
    { date: "24 July 2026", label: "Acceptance", desc: "Notification of acceptance" },
    { date: "30 July 2026", label: "Final Submission", desc: "Camera-ready submission" },
    { date: "2 August 2026", label: "Conference Date", desc: "Main event" }
  ]
};
